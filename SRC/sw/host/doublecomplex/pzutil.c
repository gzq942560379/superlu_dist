...
#ifdef USE_OPT
    egraph_destroy(Llu->graph);
    egraph_destroy(Llu->graph_r);
    SUPERLU_FREE(Llu->graph);
    SUPERLU_FREE(Llu->graph_r);
    bcast_destory_all(Llu->LB, nsupers);
    bcast_destory_all(Llu->UB, nsupers);
#endif
